...
def draw_ship(w, c_x, c_y):
    ...
    body = pygame.Rect(c_x - 100, c_y - 50, 200, 100)
    ...
    highlight = pygame.Rect(c_x - 150, c_y - 20, 300, 50)
    ...
    ring = pygame.Rect(c_x - 150, c_y - 25, 300, 50)
